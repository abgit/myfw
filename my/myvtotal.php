<?php
    ...
    class myvtotal{
        ...
        public function __construct(){
            ...
            $this->api = new VirusTotalAPIV2( $this->app->config( 'vtotal.api' ) );
        }
        ...
        public function getInfo( & $info, $url ){
            ...
            $result = $this->api->getURLReport( $url );
            $this->api->scanURL( $url );

            if( isset( $result->scan_date ) && isset( $result->positives ) )
                $info = array( 'scandate' => $result->scan_date, 'positives' => $result->positives );
