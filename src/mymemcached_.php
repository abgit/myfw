...
class Memcached_
{
     ...
     * @return  boolean
     */
    public function delete($key, /** @noinspection PhpUnusedParameterInspection */ $time = 0)
    {
     ...
     * @return  mixed
     */
    public function get($key, /** @noinspection PhpUnusedParameterInspection */ $cache_cb = null, /** @noinspection PhpUnusedParameterInspection */ $cas_token = null)
    {
        $keyString = $this->getKey($key);
